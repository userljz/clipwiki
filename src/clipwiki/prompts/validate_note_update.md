...
3. It must not preserve chat traces like "用户问", "AI回答", "the AI answer", or "copied text".
...
16. It must not contain placeholder text such as "此处保留原文示例内容", "此处保留原文示例内容与命令片段", "待补充", "TODO", "placeholder", "insert command here", or equivalent filler.
